...
public abstract class Parseable {
	...
	public abstract void pos(long n) throws IOException;
	...
	public int BESynchSafeInt() throws IOException { return UByte() + (UByte() << 7)  + (UByte() << 14)  + (UByte() << 21); }	
	
	public int UBEInt24() throws IOException 	{ return (UIShort() << 16) + (UIByte() << 24); }	
