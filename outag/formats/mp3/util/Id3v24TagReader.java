...
import outag.formats.mp3.util.id3frames.ApicId3Frame;
import outag.formats.mp3.util.id3frames.CommId3Frame;
import outag.formats.mp3.util.id3frames.GenericId3Frame;
import outag.formats.mp3.util.id3frames.Id3Frame;
import outag.formats.mp3.util.id3frames.TextId3Frame;
import outag.formats.mp3.util.id3frames.TimeId3Frame;
import outag.formats.mp3.util.id3frames.UfidId3Frame;
