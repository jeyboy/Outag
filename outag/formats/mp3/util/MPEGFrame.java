...
/** MPEG Frame object that represent a Mpeg frame in a mp3 file */
public class MPEGFrame {
	private byte[] mpegBytes;

	/** Version of this MPEG frame (see the constants) */
	...
	/** Indicating if this frame has padding byte */
	private boolean hasPadding;

	/** Indicating if this frame contains copyrighted material */
	private boolean isCopyrighted;

	/** Indicating if this frame contains original material */
	private boolean isOriginal;

	/** Indicating if this frame is protected */
	private boolean isProtected;

	/** Indicating if this is a valid MPEG Frame */
	private boolean isValid;

	/** Mpeg layer of this frame (see constants) */
	private int layer;
	...
	/** bitrate in kbps for the given layer, mode and value  */
	...
	/** channel modes allowed in a string representation */
	...
	/** sampling rate in Hz for a given Mpeg version */
	...
	/** Creates a new MPEG frame with the given byte array and decodes its contents
	...
	/** @return The layerVersion */
	public int getLayerVersion() { return layer; }
	...
	public String MPEGVersionToString(int i) { return MPEGVersionTable_String[i]; }

	/** string representation of the channel mode of this frame
	 * @param  i  the constant holding the channel mode */
	public String channelModeToString(int i) { return channelModeTable_String[i]; }

	/** @param  i  the constant holding the layer information
	 * @return    the string representation of this layer version */
	public String layerToString(int i) { return layerDescriptionTable_String[i]; }
	...
	private boolean isCopyrighted() { return ( (mpegBytes[3]&0x08) == 0x08); }

	/** @return the mPEGFrame attribute of the MPEGFrame object */
	private boolean isMPEGFrame() { return ( (mpegBytes[0]&0xFF) == 0xFF ) && ( (mpegBytes[1]&0xE0) == 0xE0 ); }

	/** @return the original attribute of the MPEGFrame object */
	private boolean isOriginal() {
		return (mpegBytes[3]&0x04) == 0x04;
	}

	/** @return the protected attribute of the MPEGFrame object */
	private boolean isProtected() { return (mpegBytes[1]&0x01) == 0x00;	}
	...
	/** @return channel mode */
	private int channelMode() {	return ((mpegBytes[3]&0xC0) >>> 6); }
	...
	/** @return indicating if this frame uses padding */
	private boolean hasPadding() { return (mpegBytes[2]&0x02) == 0x02; }

	/** @return the layer version */
