...
public class AsfHeader extends Chunk {
	...
	/** This method appends the given chunk to the {@linkplain #unspecifiedChunks unspecified}list.
	...
	/** @return Returns the first audio stream chunk. */
	...
	public EncodingChunk getEncodingChunk() { return encodingChunk; }

	/** @return Returns the tagHeader. */
	public ExtendedContentDescription getExtendedContentDescription() {	return extendedContentDescription; }
	...
	public StreamBitratePropertiesChunk getStreamBitratePropertiesChunk() { return this.streamBitratePropertiesChunk; }

	/** @param index index of the wanted chunk
	 * @return StreamChunk at given index. */
	public StreamChunk getStreamChunk(int index) { return this.streamChunks[index];	}

	/** @return the amount of StreamChunks in this header. */
	public int getStreamChunkCount() { return this.streamChunks.length; }

	/** @param index Index of the wanted chunk
	 * @return The unspecified chunk at given index. */
	public Chunk getUnspecifiedChunk(int index) { return this.unspecifiedChunks[index]; }

	/** @return Number of unspecified chunks. */
	public int getUnspecifiedChunkCount() { return this.unspecifiedChunks.length; }
