...
public class Mp4FtypBox extends AbstractMp4Box {
    ...
    public void processData() throws CannotReadException {
        ...
        try { majorBrand = decoder.decode((ByteBuffer) dataBuffer.slice().limit(MAJOR_BRAND_LENGTH)).toString(); }
    ...
    public static enum Brand {
        ...
        APPLE_AUDIO_ONLY("M4A ", "M4A Audio"); //Sometimes used by protected multy track audio
