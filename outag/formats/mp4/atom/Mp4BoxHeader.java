 ...
 * shouldn't really contain data, but sometimes they do. <p/>
 * Parent boxes length includes the length of their immediate sub boxes <p/>
...
public class Mp4BoxHeader {
    ...
    /** Construct empty header <br>
     * Can be populated later with update method */
    public Mp4BoxHeader() { }

     /** Construct header to allow manual creation of header for writing to file <br>
      * @param id */
    ...
    /** Construct header <br>
     * Create header using headerdata, expected to find header at headerdata current position <br>
    ...
    public int getDataLength() { return length - HEADER_LENGTH; }

    public String toString() { return "Box " + id + ":length" + length + ":filepos:" + filePos; }

    /** @return UTF_8 (always used by Mp4) */
    public String getEncoding() { return CHARSET_UTF_8; }

    /** Seek for box with the specified id starting from the current location of filepointer, <br>
