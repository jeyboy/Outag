...
import outag.formats.mp4.atom.Mp4MvhdBox;
import outag.formats.mp4.atom.Mp4StcoBox;
...
public class Mp4StcoBox extends AbstractMp4Box {
    ...
    /** Construct box from data and adjust offsets accordingly
     * @param header             header info
     * @param originalDataBuffer data of box (doesn't include header data)
     * @param adjustment */
