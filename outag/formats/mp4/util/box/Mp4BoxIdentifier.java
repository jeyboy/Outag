...
/** This a list of mp4boxes identifiers that can be found
 *  in a mp4 container. This list is by no means exhaustive. */
public enum Mp4BoxIdentifier {
    ...
    /** This is the value of the field name that is actually used to write mp4 */
    public String getName() { return fieldName; }

    /** @return description, human readable description of the atom */
