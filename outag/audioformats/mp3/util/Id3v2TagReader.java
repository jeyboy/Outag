...
/** Dispatching unit for selecting the right reader based on the found ID3V2 minor version. */
public class Id3v2TagReader {
	/** Current flags of the ID3V2 tag header.<br>
	 * By apperance:<br>
	 * <ol>
	...
	/** Stores the class which performs the reversion of the unsynchronisation process. */
	 ...
	 * @param b - A byte containing ID3 Flags
	...
	/** Reads the given file and searches for an ID3V2 Tag. If it is
	 * found and there is a reader for that version, a ID3V2 tag will be created
	 * upon the contents.<br> <b>Hint for developers:</b><br>
	 ...
	 * @param raf - The mp3 file containing the ID3V2 Tag.
	 * @return an ID3V2 tag representation.
	 * @throws CannotReadException - if the file doesn't contain <b>valid</b> ID3V2 tag data.
...
//		 ByteBuffer bb = ByteBuffer.wrap(b);
	 ...
	 * @param raf - A MappedByteBuffer containing the bytes to be dealt with.
