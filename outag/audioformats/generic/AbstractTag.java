 ...
 * {@link outag.audioformats.Tag} and introduces some more useful
...
public abstract class AbstractTag implements Tag {
	...
	/** @see outag.audioformats.Tag#add(outag.audioformats.generic.TagField) */
	...
	/** @see outag.audioformats.Tag#addAlbum(java.lang.String) */
	public void addAlbum(String s) { add(createAlbumField(s)); }

	/** @see outag.audioformats.Tag#addArtist(java.lang.String) */
	public void addArtist(String s) { add(createArtistField(s)); }

	/** @see outag.audioformats.Tag#addComment(java.lang.String) */
	public void addComment(String s) { add(createCommentField(s)); }

	/** @see outag.audioformats.Tag#addGenre(java.lang.String) */
	public void addGenre(String s) { add(createGenreField(s)); }

	/** @see outag.audioformats.Tag#addTitle(java.lang.String) */
	public void addTitle(String s) { add(createTitleField(s)); }

	/** @see outag.audioformats.Tag#addTrack(java.lang.String) */
	public void addTrack(String s) { add(createTrackField(s)); }

	/** @see outag.audioformats.Tag#addYear(java.lang.String) */
	...
	/** @see outag.audioformats.Tag#getArtist() */
	...
	/** @see outag.audioformats.Tag#getComment() */
	...
	/** @see outag.audioformats.Tag#getFields() */
	...
	/** @see outag.audioformats.Tag#getFirstAlbum() */
	public String getFirstAlbum() {
		List l = get(getAlbumId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstArtist() */
	public String getFirstArtist() {
		List l = get(getArtistId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstComment() */
	public String getFirstComment() {
		List l = get(getCommentId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstGenre() */
	public String getFirstGenre() {
		List l = get(getGenreId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstTitle() */
	public String getFirstTitle() {
		List l = get(getTitleId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstTrack() */
	public String getFirstTrack() {
		List l = get(getTrackId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getFirstYear() */
	public String getFirstYear() {
		List l = get(getYearId());
		return (l.size() != 0) ? ((TagTextField) l.get(0)).getContent() : "";
	}

	/** @see outag.audioformats.Tag#getGenre() */
	...
	/** @see outag.audioformats.Tag#getTitle() */
	...
	/** @see outag.audioformats.Tag#getTrack() */
	...
	/** @see outag.audioformats.Tag#getYear() */
	...
	/** @see outag.audioformats.Tag#hasCommonFields() */
	public boolean hasCommonFields() { return commonNumber != 0; }

	/** @see outag.audioformats.Tag#hasField(java.lang.String) */
	...
	/** @see outag.audioformats.Tag#isEmpty() */
	public boolean isEmpty() { return fields.size() == 0; }

	/** @see outag.audioformats.Tag#merge(outag.audioformats.Tag) */
	...
	/** @see outag.audioformats.Tag#set(outag.audioformats.generic.TagField) */
	...
	/** @see outag.audioformats.Tag#setAlbum(java.lang.String) */
	public void setAlbum(String s) { set(createAlbumField(s)); }

	/** @see outag.audioformats.Tag#setArtist(java.lang.String) */
	public void setArtist(String s) { set(createArtistField(s)); }

	/** @see outag.audioformats.Tag#setComment(java.lang.String) */
	public void setComment(String s) { set(createCommentField(s)); }

	/** @see outag.audioformats.Tag#setEncoding(java.lang.String) */
	...
	/** @see outag.audioformats.Tag#setGenre(java.lang.String) */
	public void setGenre(String s) { set(createGenreField(s)); }

	/** @see outag.audioformats.Tag#setTitle(java.lang.String) */
	public void setTitle(String s) { set(createTitleField(s)); }

	/** @see outag.audioformats.Tag#setTrack(java.lang.String) */
	public void setTrack(String s) { set(createTrackField(s)); }

	/** @see outag.audioformats.Tag#setYear(java.lang.String) */
