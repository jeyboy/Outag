...
import outag.audioformats.ape.util.ApeTagTextField;
...
public class ApeTag extends AbstractTag {
    ...
    protected String getTrackId() 	{ return "Track"; }
    protected String getYearId() 	{ return "Year"; }
    protected String getCommentId() { return "Comment"; }
	...
	public String toString() { return "APE "+super.toString(); }
}