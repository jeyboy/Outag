...
import outag.audioformats.generic.AbstractTag;
import outag.audioformats.generic.TagField;
import outag.audioformats.mp4.util.Mp4TagTextField;
import outag.audioformats.mp4.util.Mp4TagTextNumberField;

public class Mp4Tag extends AbstractTag {
    protected String getArtistId() 	{ return "ART"; }
    protected String getAlbumId() 	{ return "alb"; }
    protected String getTitleId() 	{ return "nam"; }
    protected String getTrackId() 	{ return "trkn"; }
    protected String getYearId() 	{ return "day"; }
    protected String getCommentId() { return "cmt"; }
    protected String getGenreId() 	{ return "gen"; }
	...
	public String toString() { return "Mpeg4 "+super.toString(); }
}