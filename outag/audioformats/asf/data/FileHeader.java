...
public class FileHeader extends Chunk {
	 ...
	 * @param fileTime - Time file or stream was created. Time is calculated since 1st January of 1601 in 100ns steps.
	...
	/** Converts {@link #getDuration()}from 100ns steps to seconds. 
	 * @return Duration of the media in seconds. */
	public int getDurationInSeconds() { return duration.divide(new BigInteger("10000000")).intValue(); }

	/** @return Returns the fileCreationTime. */
	public Date getFileCreationTime() { return fileCreationTime; }
	...
	public long getMaxPackageSize() { return maxPackageSize; }

	/** @return Returns the minPackageSize. */
	public long getMinPackageSize() { return minPackageSize; }

	/** @return Returns the packageCount. */
	public BigInteger getPackageCount() { return packageCount; }

	/** Converts {@link #getDuration()} from 100ns steps to seconds with a fractional part taking milliseconds.
	 * @return The duraion of the media in seconds (with a precision of milliseconds) */
	public float getPreciseDuration() { return (float)(getDuration().doubleValue() / 10000000d); }

	/** @return Returns the timeEndPos. */
	public BigInteger getTimeEndPos() { return timeEndPos; }

	/** @return Returns the timeStartPos. */
	public BigInteger getTimeStartPos() { return timeStartPos; }

	/**  @return Returns the uncompressedFrameSize. */
	public long getUncompressedFrameSize() { return uncompressedFrameSize; }
