 ...
 * You can get a it using {@link outag.audioformats.Tag#get(String)}. The
 ...
 * fields into {@link outag.audioformats.Tag}, however only the first one
 * will be written.) <br>
 ...
 * {@link outag.audioformats.generic.TagField}, then you must remember using
 ...
 * {@link outag.audioformats.asf.util.TagConverter}will identify this field
 * at
 * {@link outag.audioformats.asf.util.TagConverter#createContentDescription(Tag)}
 * and place the value into the corresponding java object (
 * {@link outag.audioformats.asf.data.ContentDescription}). */
