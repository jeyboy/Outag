...
import outag.audioformats.asf.data.ExtendedContentDescription;
import outag.audioformats.asf.data.wrapper.ContentDescriptorTagField;
 ...
 * {@link outag.audioformats.asf.data.AsfHeader} objects into
 * {@link outag.audioformats.Tag} objects (More extract information and
 * create a {@link outag.audioformats.generic.GenericTag}). */
public class TagConverter {
	 ...
	 * pairs, nearly each {@link outag.audioformats.generic.TagField}can be
	 * stored whithin. <br>
