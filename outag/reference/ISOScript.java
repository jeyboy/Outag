...
/** Represents the ISO Script <br>
 * Contains an enum  of script, their four letter code and description with additional
 * method to allow an enum to be found by its four letter code or its description. */
