...
public class Languages {
    ...
    public static enum Script {
    	...
    	ACH("ach", "Acoli"),
    	ADA("ada", "Adangme"),
    	AFA("afa", "Afro-Asiatic"),
    	AFH("afh", "Afrihili"),;
//TODO: finish list convertation    	
//	  ("afr", "Afrikaans"),
//	  ("aka", "Akan"),
//	  ("akk", "Akkadian"),
//	  ("alb", "Albanian"),
...
//	  ("zul", "Zulu"),
//	  ("zun", "Zuni"),
//	  ("\0\0\0", "Winamp Format"),                 //Not Part of Spec but commonly used by some applications
//	  ("XXX", "Media Monkey Format");              //Not Part of Spec but commonly used by some applications    	
